...
Matriculation number: & \fillme{fill in} \\[0.6em]
...
\noindent
I owned \textbf{RT model M3 (quadratic conflict, $\mu=a-b\Delta V^2$)}: its specification, psychological motivation, fitting and evaluation. I also built the \textbf{out-of-sample evaluation on run B} (applying run A parameters unchanged, the choice and RT predictive metrics, the by-condition breakdown and the calibration check) and the \textbf{choice-only baseline} together with the ``does RT help'' comparison on choice quantities.
...
\noindent
\textbf{Name and signature:} Maria Alejandra Pabon Galindo\quad\rule{5cm}{0.4pt}
\hfill

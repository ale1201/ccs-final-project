...
\hline
Claude (Anthropic), used through Claude Code, July--August 2026 &
A second opinion on choices I had already made, and help making sense of error messages when
my code broke &
The parts I own: RT model M1 (linear conflict, $\mu=a-b|\Delta V|$), the data pipeline and the
parameter-recovery simulation &
Advice only. I wrote and ran all of the code myself, and every modelling decision, number and
figure is my own. I can explain and reproduce all of them \\
[1.5em]
\hline
Claude (Anthropic), used through Claude Code, August 2026 &
Language and grammar correction, and help with formatting: tightening the wording and cutting
the abstract down to the 250-word limit &
The written report (\texttt{report.tex}), mainly the abstract. No results, numbers or figures
were changed &
Wording only; the content is our own. I read back every sentence that was edited and checked it
against the result it reports \\
[1.5em]
\hline
 & & & \\
[1.5em]
